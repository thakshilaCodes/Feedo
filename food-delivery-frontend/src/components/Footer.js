...
const Footer = () => {
  ...
  return (
    <footer className={`${currentTheme.primary} text-white py-8 mt-auto`}>
      <div className="max-w-6xl mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#" className="text-sm hover:underline">Partner With Us</a></li>
          ...
          <div>
            ...
            <p className="text-sm mb-2">Email: info@foodexpress.com</p>
        ...
        <div className="mt-8 pt-6 border-t border-white border-opacity-20 text-sm text-center">
